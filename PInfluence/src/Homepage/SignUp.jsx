...
const SignUpForm = () => {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "row", flexWrap: "wrap", gap: 4, width: "100%", justifyContent: "center", alignItems: "center", mt: 4 }}>
      ...
      <Box sx={{ flex: 1, minWidth: "300px", maxWidth: "500px", textAlign: "center" }}>
        ...
        >
          {["https://i.pinimg.com/474x/b4/ab/dc/b4abdc213dcb3dd6fc08264934fcd2e0.jpg", "https://i.pinimg.com/736x/a1/ab/76/a1ab761a7c5e24ccae23f5367327b4fa.jpg", "https://i.pinimg.com/474x/0d/7c/4b/0d7c4b72788d4dd6b9fc6a9d43fdf6bf.jpg", "https://i.pinimg.com/736x/4c/37/a4/4c37a452d8738da7a1fcbf6f08df6d5b.jpg"].map((src, idx) => (
            <Box
              key={idx}
              component="img"
              src={src}
