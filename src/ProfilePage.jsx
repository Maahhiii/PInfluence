    ...
    <Box sx={{ width: '100vw', minHeight: '100vh', bgcolor: '#FFF6E3' }}>
      ...
      <Box sx={{ mt: 8, textAlign: 'center', px: 2 }}>
        ...
        <Box sx={{ mt: 2, display: 'flex', justifyContent: 'center', gap: 2 }}>
          ...
          <IconButton onClick={handleLogout} sx={{ bgcolor: '#AFA8F0', color: 'white' }}>
            <LogoutIcon />
          </IconButton>
        </Box>
        ...
        <Box sx={{
          ...
          {boards.map((src, index) => (
            <Box key={index} sx={{
              ...
              <img src={src} alt={`board-${index}`} style={{
                width: '100%',
                height: '260px',
                objectFit: 'cover',
                borderRadius: '16px',
          ...
          <Box sx={{
            ...
            alignItems: 'center',
            background: 'linear-gradient(to right, rgba(175, 168, 240, 0.5), rgba(252, 156, 227, 0.5))',
          }}>
