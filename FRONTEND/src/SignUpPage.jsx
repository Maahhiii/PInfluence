...
const SignUpForm = forwardRef((props, ref) => {
  ...
  return (
    <Box ref={ref} sx={{ display: "flex", justifyContent: "center", alignItems: "center", mt: 2 }}>
      <Box sx={{ width: "100%", maxWidth: 400, p: 3, borderRadius: 3, boxShadow: "0 6px 20px rgba(0,0,0,0.1)", background: "white" }}>
        ...
        <TextField fullWidth label="Email" name="email" type="email" value={formData.email} onChange={handleChange} size="small" sx={{ mb: 2 }} />
        <TextField
          fullWidth
          label="Password"
          name="password"
